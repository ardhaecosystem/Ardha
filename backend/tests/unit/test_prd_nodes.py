    ...
    async def test_successful_requirements_extraction(self, node, sample_prd_state, mock_context):
        ...
        mock_response = json.dumps({
            ...
            "requirements_summary": {
                ...
                "by_category": {"functional": 1, "non_functional": 1, "business": 1, "technical": 1}
            }
        })
    ...
    async def test_balanced_prioritization(self, node, state_with_requirements, mock_context):
        ...
        mock_response = json.dumps({
            ...
            "feature_roadmap": {
                ...
                "wont_have_features": [],
                "total_features": 10,
                "priority_distribution": {"M": 3, "S": 4, "C": 2, "W": 1}  # Balanced distribution
            },
            "release_phases": []
        })
...
class TestSetMetricsNode:
    ...
    async def test_successful_metrics_definition(self, node, state_with_features, mock_context):
        ...
        mock_response = json.dumps({
            ...
            "metrics_summary": {
                "total_metrics": 2,
                "by_category": {"user_engagement": 1, "business": 1, "technical": 0, "quality": 0, "adoption": 0},
                "measurement_frequency": {"real_time": 0, "daily": 1, "weekly": 0, "monthly": 1, "quarterly": 0}
            }
        })
...
"""
        ...
        mock_context.openrouter_client.complete.return_value = MagicMock(
            content=mock_response,
            usage=MagicMock(prompt_tokens=1000, completion_tokens=800)
        )
...
"""
        ...
        mock_context.openrouter_client.complete.return_value = MagicMock(
            content=mock_response,
            usage=MagicMock(prompt_tokens=1500, completion_tokens=1200)
        )
