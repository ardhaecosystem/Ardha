            ...
            mock_responses = {
                "extract_requirements": json.dumps({
                    ...
                    "requirements_summary": {
                        ...
                        "by_category": {"functional": 3, "non_functional": 3, "business": 1, "technical": 1}
                    }
                }),
                ...
                "set_metrics": json.dumps({
                    ...
                    "kpi_dashboard": {
                        ...
                        "secondary_kpis": ["Session Duration", "CAC", "Uptime", "Retention Rate"],
                        "monitoring_tools": ["User analytics", "Payment processor", "Infrastructure monitoring", "Survey tools"]
                    },
                    "metrics_summary": {
                        "total_metrics": 8,
                        "by_category": {"user_engagement": 2, "business": 2, "technical": 2, "quality": 1, "adoption": 1},
                        "measurement_frequency": {"real_time": 2, "daily": 1, "weekly": 1, "monthly": 3, "quarterly": 1}
                    }
                }),
                ...
                if call_count == 1:
                    ...
                    response.content = json.dumps({
                        ...
                        "requirements_summary": {
                            ...
                            "by_category": {"functional": 1, "non_functional": 0, "business": 0, "technical": 0}
                        }
                    })
                    response.usage = MagicMock(prompt_tokens=1000, completion_tokens=500)
                    return response
