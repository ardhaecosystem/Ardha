...
class TestChatAPI:
    ...
    async def test_create_chat_with_project(self, client: AsyncClient, test_user: dict, test_project: dict):
    ...
    async def test_list_chats_with_project_filter(self, client: AsyncClient, test_user: dict, test_project: dict):
    ...
    async def test_send_message_endpoint(self, mock_openrouter_class, client: AsyncClient, test_user: dict):
    ...
    @pytest.mark.skip(reason="WebSocket testing requires httpx-ws or Starlette TestClient. httpx.AsyncClient does not support websocket_connect().")
    ...
    async def test_chat_permission_enforcement_api(self, client: AsyncClient, test_user: dict):
        ...
        endpoints = [
            ("GET", f"/api/v1/chats/{chat_id}/messages"),
            ("POST", f"/api/v1/chats/{chat_id}/messages", {"content": "Hello", "model": "gpt-3.5-turbo"}),
            ("POST", f"/api/v1/chats/{chat_id}/archive"),
            ("GET", f"/api/v1/chats/{chat_id}/summary"),
        ]
