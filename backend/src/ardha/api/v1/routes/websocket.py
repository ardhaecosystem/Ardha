...
class WebSocketManager:
    ...
    async def connect(websocket: WebSocket, chat_id: UUID) -> None:
        ...
        logger.info(f"WebSocket connected to chat {chat_id}. Total connections: {len(active_connections[chat_id])}")
    ...
    @staticmethod
    async def broadcast_to_chat(message: str, chat_id: UUID, exclude_websocket: Optional[WebSocket] = None) -> None:
                ...
                try:
                    ...
                    if message_type == "message":
                        ...
                        confirmation = json.dumps({
                            ...
                            "content": content,
                            "timestamp": str(websocket.scope.get("state", {}).get("receive_time", ""))
                        })
                        ...
                        try:
                            ...
                            async for chunk in chat_service.send_message(
                                ...
                                await WebSocketManager.broadcast_to_chat(chunk_msg, chat_id, websocket)
                                full_response += chunk
