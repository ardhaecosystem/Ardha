...
from .state import WorkflowState, WorkflowStatus, WorkflowType, WorkflowContext
from .nodes import (
    BaseNode, ResearchNode, ArchitectNode, ImplementNode, 
    DebugNode, MemoryIngestionNode
)
    ...
    def _get_default_node_sequence(self, workflow_type: WorkflowType) -> List[str]:
        ...
        sequences = {
            ...
            WorkflowType.FULL_DEVELOPMENT: [
                "research", "architect", "implement", "debug", "memory_ingestion"
            ],
