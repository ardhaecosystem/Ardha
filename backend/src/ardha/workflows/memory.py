...
class MemoryIngestionService:
    ...
    async def ingest_workflow_execution(
        ...
        try:
            ...
            if success:
                ...
                self.logger.error(f"Failed to ingest workflow execution: {workflow_state.execution_id}")
                return False
    ...
    async def search_workflows(
        ...
        try:
            ...
            workflows = results if results else []  # Results are already dictionaries from search_similar
    ...
    async def search_conversations(
        ...
        try:
            ...
            # Extract payloads from results
            conversations = results if results else []  # Results are already dictionaries from search_similar
            
            self.logger.info(f"Found {len(conversations)} matching conversations for query: {query}")
    ...
    async def search_artifacts(
        ...
        try:
            ...
            # Extract payloads from results
            artifacts = results if results else []  # Results are already dictionaries from search_similar
    ...
    async def get_workflow_context(
        ...
        try:
            ...
            context_query = f"user context preferences project {project_id}" if project_id else "user context preferences"
