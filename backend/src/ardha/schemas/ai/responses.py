...
class Choice(BaseModel):
    ...
    finish_reason: Optional[FinishReason] = Field(default=None, description="Why this choice finished")
...
class CompletionResponse(BaseModel):
    ...
    system_fingerprint: Optional[str] = Field(default=None, description="System fingerprint for reproducibility")
...
class TokenCountResponse(BaseModel):
    ...
    messages: Optional[List[Dict[str, Any]]] = Field(default=None, description="Original messages (if provided)")
...
class CostInfo(BaseModel):
    ...
    @classmethod
    def from_usage(cls, model: str, usage: UsageInfo, input_cost_per_token: float, output_cost_per_token: float) -> "CostInfo":
...
class CircuitBreakerState(BaseModel):
    ...
    last_failure_time: Optional[int] = Field(default=None, description="Unix timestamp of last failure")
    next_attempt_time: Optional[int] = Field(default=None, description="Unix timestamp when next attempt is allowed")
