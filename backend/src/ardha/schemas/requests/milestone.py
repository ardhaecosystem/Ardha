...
class MilestoneCreateRequest(BaseModel):
    ...
    order: int | None = Field(None, ge=0, description="Display order (auto-assigned if not provided)")
...
class MilestoneUpdateRequest(BaseModel):
    ...
    name: str | None = Field(None, min_length=1, max_length=255, description="Milestone display name")
    description: str | None = Field(None, description="Optional detailed description")
