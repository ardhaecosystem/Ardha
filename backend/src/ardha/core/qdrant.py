...
class QdrantService:
    ...
    def _get_collection_name(self, collection_type: str, identifier: Optional[Union[str, UUID]] = None) -> str:
        """
    ...
    async def delete_collection(self, collection_type: str, identifier: Optional[Union[str, UUID]] = None) -> bool:
        """
        Delete a collection.
    ...
    async def collection_exists(self, collection_type: str, identifier: Optional[Union[str, UUID]] = None) -> bool:
        """
    ...
    async def get_collection_info(self, collection_type: str, identifier: Optional[Union[str, UUID]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "config": {
                    "vector_size": getattr(getattr(info, 'config', {}), 'params', {}).get('vectors', {}).get('size', 0),
                    "distance": getattr(getattr(info, 'config', {}), 'params', {}).get('vectors', {}).get('distance', {}).value if hasattr(getattr(getattr(info, 'config', {}), 'params', {}).get('vectors', {}).get('distance', {}), 'value') else None,
                },
            }
