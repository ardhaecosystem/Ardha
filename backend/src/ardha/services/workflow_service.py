...
from ..core.exceptions import ServiceError, NotFoundError, ValidationError
...
class WorkflowService:
    ...
    async def execute_workflow(
        ...
        try:
            ...
            try:
                await self._start_workflow_execution(execution.id, workflow_enum, initial_request, parameters, context)
    ...
    async def get_execution(self, execution_id: UUID, user_id: UUID) -> Optional[WorkflowExecution]:
        ...
        try:
            ...
            if execution.user_id != user_id:
                raise NotFoundError("Execution not found", resource_type="WorkflowExecution", resource_id=str(execution_id))
        ...
        try:
            ...
            try:
                ...
                await self.repository.update_status(
                    execution_id,
                    WorkflowStatus.FAILED,
                    error_message=f"Failed to resume: {str(e)}"
                )
