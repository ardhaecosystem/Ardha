...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        ...
        if response.status_code == 400 and ("already" in response.text.lower() or "exists" in response.text.lower()):
        ...
        response = await client.get(
            f"{API_V1}/milestones/{milestone1['id']}",
            headers=headers
        )
        ...
        for i in range(3):
            ...
            response = await client.post(
                f"{API_V1}/tasks/projects/{project_id}/tasks",
                json=task_data,
                headers=headers
            )
        ...
        response = await client.post(
            f"{API_V1}/milestones/{milestone1['id']}/recalculate",
            headers=headers
        )
        ...
        response = await client.get(
            f"{API_V1}/milestones/{milestone1['id']}/summary",
            headers=headers
        )
        ...
        response = await client.get(
            f"{API_V1}/milestones/projects/{project_id}/milestones/roadmap",
            headers=headers
        )
        ...
        response = await client.delete(
            f"{API_V1}/milestones/{milestone3['id']}",
            headers=headers
        )
