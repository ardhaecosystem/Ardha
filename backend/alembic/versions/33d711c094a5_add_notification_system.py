...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "task_assigned", sa.Boolean(), nullable=False, comment="Notify when assigned to task"
        ),
        sa.Column(
            "task_completed",
            sa.Boolean(),
        ...
        sa.Column(
            "task_overdue", sa.Boolean(), nullable=False, comment="Notify about overdue tasks"
        ),
        sa.Column(
            "mentions",
            sa.Boolean(),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
            "user_id", sa.UUID(), nullable=False, comment="User who receives this notification"
        ),
        sa.Column(
            "type",
            sa.String(length=50),
        ...
        sa.Column(
            "title", sa.String(length=200), nullable=False, comment="Short notification title"
        ),
        sa.Column(
            "message",
            sa.Text(),
        ...
        sa.Column(
            "is_read", sa.Boolean(), nullable=False, comment="Whether notification has been read"
        ),
        sa.Column(
            "read_at",
            sa.DateTime(timezone=True),
        ...
        sa.CheckConstraint(
            "type IN ('task_assigned', 'task_completed', 'task_overdue', 'mention', 'project_invite', 'database_update', 'system')",
