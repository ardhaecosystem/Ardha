...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "color", sa.String(length=7), nullable=False, comment="Hex color code for UI display"
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "created_by_id", sa.UUID(), nullable=False, comment="User or AI that created this task"
        ),
        sa.Column(
            "phase",
        ...
        sa.Column(
            "openspec_proposal_id", sa.UUID(), nullable=True, comment="Linked OpenSpec proposal"
        ),
        sa.Column(
        ...
        sa.Column(
            "ai_generated", sa.Boolean(), nullable=False, comment="Was this task created by AI?"
        ),
        sa.Column(
        ...
        sa.CheckConstraint(
            "priority IN ('urgent', 'high', 'medium', 'low')", name="ck_task_priority"
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "actual_hours IS NULL OR actual_hours >= 0", name="ck_task_actual_hours"
        ),
        sa.CheckConstraint(
        ...
        sa.CheckConstraint(
            "estimate_hours IS NULL OR estimate_hours >= 0", name="ck_task_estimate_hours"
        ),
