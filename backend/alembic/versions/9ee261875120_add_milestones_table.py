...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "start_date", sa.DateTime(timezone=True), nullable=True, comment="Optional start date"
        ),
        sa.Column(
            "due_date",
        ...
        sa.Column(
            "order", sa.Integer(), nullable=False, comment="Display order for drag-drop sorting"
        ),
