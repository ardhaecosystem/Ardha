...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "repository_name", sa.String(length=255), nullable=False, comment="Repository name"
        ),
        sa.Column(
            "repository_url",
        ...
        sa.Column(
            "default_branch", sa.String(length=255), nullable=False, comment="Default branch name"
        ),
        sa.Column(
        ...
        sa.Column(
            "require_review", sa.Boolean(), nullable=False, comment="Enforce PR review requirements"
        ),
        sa.Column(
        ...
        sa.Column(
            "webhook_url", sa.String(length=512), nullable=True, comment="Registered webhook URL"
        ),
        sa.Column(
            "webhook_events", sa.JSON(), nullable=True, comment="List of subscribed webhook events"
        ),
        sa.Column(
            "is_active", sa.Boolean(), nullable=False, comment="Whether integration is active"
        ),
        sa.Column(
            "last_sync_at",
            sa.DateTime(timezone=True),
        ...
        sa.CheckConstraint(
            "webhook_events_received >= 0", name="ck_github_integration_webhook_events_received"
        ),
    ...
    op.create_index(
        "ix_github_integration_repository",
        "github_integrations",
        ["repository_owner", "repository_name"],
        unique=False,
    )
    op.create_index(
        "ix_github_integration_status", "github_integrations", ["connection_status"], unique=False
    )
    op.create_index(
        op.f("ix_github_integrations_connection_status"),
        "github_integrations",
        ["connection_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_integrations_created_by_user_id"),
        "github_integrations",
        ["created_by_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_integrations_installation_id"),
        "github_integrations",
        ["installation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_integrations_is_active"), "github_integrations", ["is_active"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_github_integrations_repository_name"),
        "github_integrations",
        ["repository_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_integrations_repository_owner"),
        "github_integrations",
        ["repository_owner"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "delivery_id", sa.String(length=255), nullable=False, comment="GitHub's delivery UUID"
        ),
        sa.Column(
            "event_type",
        ...
        sa.ForeignKeyConstraint(
            ["github_integration_id"], ["github_integrations.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("delivery_id", name="uq_webhook_delivery_id"),
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_action"),
        "github_webhook_deliveries",
        ["action"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_commit_sha"),
        "github_webhook_deliveries",
        ["commit_sha"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_github_webhook_deliveries_github_integration_id"),
        "github_webhook_deliveries",
        ["github_integration_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_pr_number"),
        "github_webhook_deliveries",
        ["pr_number"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_received_at"),
        "github_webhook_deliveries",
        ["received_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_related_entity_id"),
        "github_webhook_deliveries",
        ["related_entity_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_related_entity_type"),
        "github_webhook_deliveries",
        ["related_entity_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_signature_verified"),
        "github_webhook_deliveries",
        ["signature_verified"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_webhook_deliveries_status"),
        "github_webhook_deliveries",
        ["status"],
        unique=False,
    )
    op.create_index(
        "ix_webhook_commit_sha", "github_webhook_deliveries", ["commit_sha"], unique=False
    )
    op.create_index(
        "ix_webhook_entity_type", "github_webhook_deliveries", ["related_entity_type"], unique=False
    )
    op.create_index(
        "ix_webhook_event_type", "github_webhook_deliveries", ["event_type"], unique=False
    )
    op.create_index(
        "ix_webhook_integration",
        "github_webhook_deliveries",
        ["github_integration_id"],
        unique=False,
    )
    op.create_index(
        "ix_webhook_pr_number", "github_webhook_deliveries", ["pr_number"], unique=False
    )
    op.create_index(
        "ix_webhook_received",
        "github_webhook_deliveries",
    ...
    op.create_table(
        ...
        sa.Column(
            "github_pr_id", sa.BigInteger(), nullable=False, comment="GitHub's internal PR ID"
        ),
        ...
        sa.Column(
            "head_sha", sa.String(length=40), nullable=False, comment="Latest commit SHA in PR"
        ),
        sa.Column(
        ...
        sa.Column(
            "merged_at", sa.DateTime(timezone=True), nullable=True, comment="Merge timestamp"
        ),
        sa.Column(
            "merged_by_github_username",
            sa.String(length=255),
            nullable=True,
            comment="GitHub username who merged the PR",
        ),
        sa.Column(
            "closed_at", sa.DateTime(timezone=True), nullable=True, comment="Close timestamp"
        ),
        sa.Column(
            "review_status",
            sa.String(length=30),
        ...
        sa.Column(
            "api_url", sa.String(length=512), nullable=False, comment="GitHub API URL for this PR"
        ),
        sa.Column(
            "linked_task_ids",
            sa.JSON(),
    ...
    op.create_index(
        op.f("ix_pull_requests_author_github_username"),
        "pull_requests",
        ["author_github_username"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pull_requests_author_user_id"), "pull_requests", ["author_user_id"], unique=False
    )
    op.create_index(
        op.f("ix_pull_requests_base_branch"), "pull_requests", ["base_branch"], unique=False
    )
    op.create_index(
        op.f("ix_pull_requests_checks_status"), "pull_requests", ["checks_status"], unique=False
    )
    op.create_index(
        op.f("ix_pull_requests_github_integration_id"),
        "pull_requests",
        ["github_integration_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_pull_requests_github_pr_id"), "pull_requests", ["github_pr_id"], unique=False
    )
    op.create_index(
        op.f("ix_pull_requests_head_branch"), "pull_requests", ["head_branch"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_pull_requests_review_status"), "pull_requests", ["review_status"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "position", sa.Integer(), nullable=False, comment="Order of this commit in the PR"
        ),
        sa.Column(
            "added_at",
            sa.DateTime(timezone=True),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_github_webhook_deliveries_status"), table_name="github_webhook_deliveries"
    )
    op.drop_index(
        op.f("ix_github_webhook_deliveries_signature_verified"),
        table_name="github_webhook_deliveries",
    ...
    op.drop_index(
        op.f("ix_github_webhook_deliveries_received_at"), table_name="github_webhook_deliveries"
    )
    op.drop_index(
        op.f("ix_github_webhook_deliveries_pr_number"), table_name="github_webhook_deliveries"
    )
    op.drop_index(
        op.f("ix_github_webhook_deliveries_github_integration_id"),
        table_name="github_webhook_deliveries",
    ...
    op.drop_index(
        op.f("ix_github_webhook_deliveries_delivery_id"), table_name="github_webhook_deliveries"
    )
    op.drop_index(
        op.f("ix_github_webhook_deliveries_commit_sha"), table_name="github_webhook_deliveries"
    )
    op.drop_index(
        op.f("ix_github_webhook_deliveries_action"), table_name="github_webhook_deliveries"
    )
    ...
    op.drop_index(
        op.f("ix_github_integrations_created_by_user_id"), table_name="github_integrations"
    )
    op.drop_index(
        op.f("ix_github_integrations_connection_status"), table_name="github_integrations"
    )
