"""add server default to database_entry last_edited_at

Revision ID: 606c1d22f358
Revises: 436d6f22de59
Create Date: 2025-11-19 09:56:16.402139
...
revision: str = "606c1d22f358"
down_revision: Union[str, None] = "436d6f22de59"
...
def upgrade() -> None:
    ...
    # Add server default to database_entries.last_edited_at
    op.alter_column(
        "database_entries",
        "last_edited_at",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    # Remove server default from database_entries.last_edited_at
    op.alter_column(
        "database_entries",
        "last_edited_at",
        server_default=None,
