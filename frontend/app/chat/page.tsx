...
import { useChats, useChat, useChatMessages, useSendMessage, useCreateChat, type Chat } from '@/hooks/use-chats';
            ...
            <div className="glass-panel border-b border-white/10 p-4">
              <div className="max-w-4xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <option value="anthropic/claude-sonnet-4-20250514" className="bg-gray-900">Claude Sonnet 4.5</option>
                    <option value="anthropic/claude-opus-4-20250514" className="bg-gray-900">Claude Opus 4.1</option>
                    <option value="z-ai/glm-4.6" className="bg-gray-900">GLM 4.6</option>
                    <option value="x-ai/grok-code-fast-1" className="bg-gray-900">Grok Code Fast</option>
                    <option value="google/gemini-2.0-flash-001:free" className="bg-gray-900">Gemini Flash</option>
                  </select>
              ...
              <div className="max-w-4xl mx-auto space-y-6">
                {messagesLoading ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-white/60 text-sm mt-4">Loading messages...</p>
                  </div>
                ) : messages.length > 0 ? (
                  <>
            ...
            <div className="text-center max-w-2xl px-8">
              ...
              <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
                ...
                >
                  ...
                  <div className="text-white/40 text-xs mt-1">Start a conversation</div>
                </button>
                ...
                >
                  ...
                  <div className="text-white/40 text-xs mt-1">Analyze and explore</div>
                </button>
                ...
                >
                  ...
                  <div className="text-white/40 text-xs mt-1">Design systems</div>
                </button>
