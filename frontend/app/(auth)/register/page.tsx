...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full relative bg-black flex items-center justify-center p-4 overflow-hidden">
      ...
      {/* Floating Orbs */}
      <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-purple-500/30 rounded-full blur-3xl animate-float-slow" />
      <div
        className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-blue-500/30 rounded-full blur-3xl animate-float-slow"
          ...
          <div className="space-y-1.5">
            <div className="flex items-start ml-1">
              <input
                ...
                onChange={handleChange}
                className="mt-1 w-4 h-4 rounded border-white/20 bg-white/5 text-primary focus:ring-primary/50 focus:ring-offset-0 transition-all"
              />
              <label
                htmlFor="agreeToTerms"
                className="ml-2 text-xs text-white/60 leading-relaxed"
              >
            ...
            {errors.agreeToTerms && (
              <p className="text-xs text-red-400 ml-1">{errors.agreeToTerms}</p>
            )}
          </div>
